...
CREATE TABLE `negocios` (
  ...
  `logo` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'http://www.upyapp.com/images/emptyview.png',
  `img1` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'http://www.upyapp.com/images/emptyview.png',
  `img2` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'http://www.upyapp.com/images/emptyview.png',
  `img3` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'http://www.upyapp.com/images/emptyview.png',
  `img4` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'http://www.upyapp.com/images/emptyview.png',
  `img5` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'http://www.upyapp.com/images/emptyview.png',
...
CREATE TABLE horario (
    negocio_id tinyint(12) NOT NULL,
    lunes VARCHAR(50) COLLATE utf8_unicode_ci DEFAULT NULL,
    martes VARCHAR(50) COLLATE utf8_unicode_ci DEFAULT NULL,
    miercoles VARCHAR(50) COLLATE utf8_unicode_ci DEFAULT NULL,
    jueves VARCHAR(50) COLLATE utf8_unicode_ci DEFAULT NULL,
    viernes VARCHAR(50) COLLATE utf8_unicode_ci DEFAULT NULL,
    sabado VARCHAR(50) COLLATE utf8_unicode_ci DEFAULT NULL,
    domingo VARCHAR(50) COLLATE utf8_unicode_ci DEFAULT NULL,
